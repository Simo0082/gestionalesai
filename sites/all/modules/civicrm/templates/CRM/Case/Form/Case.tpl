...
{if $form.medium_id.html and $form.activity_location.html}
    <tr class="crm-case-form-block-medium_id">
        <td  style="display:none;" class="label">{$form.medium_id.label}</td>

        <td style="display:none;" class="view-value">{$form.medium_id.html}&nbsp;&nbsp;&nbsp;{$form.activity_location.label} &nbsp;{$form.activity_location.html}</td>
...
{if $form.activity_details.html}
    <tr class="crm-case-form-block-activity_details">
        <td class="label">Descrizione del caso{help id="id-details" activityTypeFile=$activityTypeFile file="CRM/Case/Form/Case.hlp"}</td>
...
{if $form.duration.html}
    <tr class="crm-case-form-block-duration">
      <td style="display:none;"  class="label">{$form.duration.label}</td>
