<?php /* Smarty version 2.6.31, created on 2023-07-16 18:27:40
         compiled from CRM/Custom/Form/Group.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Custom/Form/Group.tpl', 1, false),array('block', 'ts', 'CRM/Custom/Form/Group.tpl', 27, false),array('block', 'crmButton', 'CRM/Custom/Form/Group.tpl', 85, false),array('function', 'help', 'CRM/Custom/Form/Group.tpl', 27, false),array('modifier', 'json_encode', 'CRM/Custom/Form/Group.tpl', 96, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div class="help"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Use Custom Field Sets to add logically related fields for a specific type of CiviCRM record (e.g. contact records, contribution records, etc.).<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?> <?php echo smarty_function_help(array('id' => "id-group_intro"), $this);?>
</div>
...
&nbsp;<?php echo $this->_tpl_vars['form']['is_multiple']['label']; ?>
 ...
 <?php echo smarty_function_help(array('id' => "id-is-public"), $this);?>
</td>
    </tr>
    <tr class="html-adjust">
...
CRM.$(function($) {
  ...
  var isGroupEmpty = '; ?>
<?php echo json_encode($this->_tpl_vars['isGroupEmpty']); ?>
<?php echo ';
  if (isGroupEmpty) {
    showRange(true);
  }
...
<?php echo ';
    ...
    if (warning) {
      return confirm('; ?>
'<?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Warning: You have chosen to remove one or more subtypes. This will cause any custom data records associated with those subtypes to be removed as long as the contact does not have a contact subtype still selected.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>'<?php echo ');
    }
    return true;
  });
});
