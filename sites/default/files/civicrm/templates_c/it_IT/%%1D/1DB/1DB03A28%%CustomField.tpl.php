<?php /* Smarty version 2.6.31, created on 2023-07-16 18:24:01
         compiled from CRM/Custom/Form/Edit/CustomField.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Custom/Form/Edit/CustomField.tpl', 1, false),array('block', 'ts', 'CRM/Custom/Form/Edit/CustomField.tpl', 71, false),array('function', 'help', 'CRM/Custom/Form/Edit/CustomField.tpl', 36, false),)), $this); ?>
...
-row">
    <td
      class="label"><?php echo $this->_tpl_vars['formElement']['label']; ?>
    ...
    <td class="html-adjust">
      ...
      <table class="form-layout-compressed" style="margin-top: -0.5em;">
        <tr>
          ...
          <?php $_from = $this->_tpl_vars['formElement']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
...
?>
          ...
          <?php else: ?>
          <td class="labels font-light"><?php echo $this->_tpl_vars['formElement'][$this->_tpl_vars['key']]['html']; ?>
</td>
...
<?php else: ?>
  <tr class="custom_field-row <?php echo $this->_tpl_vars['element']['element_name']; ?>
-row">
    <td class="label"><?php echo $this->_tpl_vars['formElement']['label']; ?>
...
&nbsp;
      <?php if ($this->_tpl_vars['element']['data_type'] == 'File'): ?>
        <?php if ($this->_tpl_vars['element']['element_value']['data']): ?>
          <div class="crm-attachment-wrapper crm-entity" id="file_<?php echo $this->_tpl_vars['element']['element_name']; ?>
">
            <span class="html-adjust"><br/>&nbsp;<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Attached File<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>: &nbsp;
...
"><?php echo $this->_tpl_vars['element']['element_value']['fileName']; ?>
              ...
              <?php if ($this->_tpl_vars['element']['element_value']['deleteURL']): ?>
                <a href="#" class="crm-hover-button delete-attachment"
                   data-filename="<?php echo $this->_tpl_vars['element']['element_value']['fileName']; ?>
"
