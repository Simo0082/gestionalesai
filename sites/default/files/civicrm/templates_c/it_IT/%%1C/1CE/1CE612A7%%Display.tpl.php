...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('crmURL', ob_get_contents());ob_end_clean(); ?>
    ...
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description">
        <?php echo $this->_tpl_vars['settings_fields']['contact_smart_group_display']['description']; ?>
...
-contactedit" class="ui-state-default ui-corner-all"
    ...
    <tr class="crm-preferences-display-form-block-contact_ajax_check_similar">
      <td class="label"><?php echo $this->_tpl_vars['form']['contact_ajax_check_similar']['label']; ?>
</td>
    ...
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <?php ob_start(); ?>href="<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/deduperules','q' => 'reset=1'), $this);?>
"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('dedupeRules', ob_get_contents());ob_end_clean(); ?>
      <td class="description"><?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['dedupeRules'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>When enabled, checks for possible matches on the "New Contact" form using the Supervised <a %1>matching rule specified in your system</a>.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
      </td>
    </tr>
    ...
    <tr class="crm-preferences-display-form-activity_types">
      <td class="label"><?php echo $this->_tpl_vars['form']['do_not_notify_assignees_for']['label']; ?>
</td>
      <td><?php echo $this->_tpl_vars['form']['do_not_notify_assignees_for']['html']; ?>
</td>
    </tr>
    <tr class="crm-preferences-display-form-activity_types">
      <td>&nbsp;</td>
      <td class="description">
        <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>These activity types will be excluded from automated email notifications to assignees.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
      </td>
    </tr>
    ...
    <tr class="crm-preferences-display-form-block-preserve_activity_tab_filter">
      <td class="label"></td>
      <td><?php echo $this->_tpl_vars['form']['preserve_activity_tab_filter']['html']; ?>
</td>
    </tr>
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description"><?php echo $this->_tpl_vars['settings_fields']['preserve_activity_tab_filter']['description']; ?>
</td>
    </tr>
...
<span id="invoice_help">  <?php echo smarty_function_help(array('id' => "id-invoices_id"), $this);?>
    ...
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description">
        <?php echo $this->_tpl_vars['settings_fields']['user_dashboard_options']['description']; ?>

      </td>
    </tr>
    <tr class="crm-preferences-display-form-block-editor_id">
      <td class="label"><?php echo $this->_tpl_vars['form']['editor_id']['label']; ?>
 <?php echo smarty_function_help(array('id' => 'editor_id'), $this);?>
</td>
      <td>
        <?php echo $this->_tpl_vars['form']['editor_id']['html']; ?>
        ...
        <span class="crm-button crm-icon-button" style="display:inline-block;vertical-align:middle;float:none!important;">
          ...
          <?php echo $this->_tpl_vars['form']['ckeditor_config']['html']; ?>
    ...
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description"><?php echo $this->_tpl_vars['settings_fields']['display_name_format']['description']; ?>
</td>
    </tr>
    ...
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description"><?php echo $this->_tpl_vars['settings_fields']['sort_name_format']['description']; ?>
</td>
    </tr>
  </table>
  <div class="crm-submit-buttons"><?php $_smarty_tpl_vars = $this->_tpl_vars;
