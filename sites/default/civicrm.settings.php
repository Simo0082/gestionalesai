...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://sammartini:bB37#2rr#S0t@localhost/sammartini_db?new_link=true');
#	34.154.159.121
#define( 'CIVICRM_UF_DSN'           , 'mysql://sammartini:bB37#2rr#S0t@34.154.15.131/sammartini_db?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://sammartini:bB37#2rr#S0t@localhost/sammartini_db?new_link=true');
#   define('CIVICRM_DSN', 'mysql://sammartini:bB37#2rr#S0t@34.154.15.131/sammartini_db?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://34.154.205.81');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '59470808bd9ccb4310f5982d36f98e11');
}
